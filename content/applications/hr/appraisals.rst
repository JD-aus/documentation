...
responded to a question, and how many people skipped it. All answers for each question are visible.
...
- :guilabel:`Stats banner`: the status of the appraisal. A banner appears if an appraisal is
  :guilabel:`Canceled` or if it is :guilabel:`Done`.
...
section of the :guilabel:`Appraisal` tab is grayed out. The information in that section only appears
...
The other method is in the goal card itself. Click on a goal card to open the goal form. Click the
